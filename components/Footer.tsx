    ...
    <footer className="bg-[#0B1320] text-white py-12 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-1">
          ...
          <div className="flex gap-4">
            ...
            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">TW</div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            <li><Link href="#jastip" className="hover:text-white transition-colors">Jastip Korea</Link></li>
            <li><Link href="#warehouse" className="hover:text-white transition-colors">Gudang/Warehouse Seoul</Link></li>
            <li><Link href="#forwarding" className="hover:text-white transition-colors">Forwarding Korea - ID</Link></li>
            <li><Link href="#tracking" className="hover:text-white transition-colors">Tracking Paket</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-300">
            ...
            <li><Link href="#kebijakan" className="hover:text-white transition-colors">Kebijakan Privasi</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
        ...
        <div className="flex gap-4 mt-4 md:mt-0">
          <Link href="#syarat" className="hover:text-white transition-colors">Syarat Kebijakan</Link>
